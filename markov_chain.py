...
for i in range(len(tOccr)):
    ...
    for j in range(len(tOccr)):
        tProb[j][i] = round(int(tOccr[j][i]) / f, 6)
    f = 0
...
for i in range(len(tProb)):
    if i == 0:
        ...
        print('{:<7}{:<7}{:<7}{:<7}{:<7}{:<7}{:<7}{:<7}{:<7}{:<7}{:<7}{:<7}{:<7}{:<7}{:<7}{:<7}{:<7}{:<7}{:<7}{:<7}{:<7}{:<7}{:<7}{:<7}'.format(states[0], states[1], states[2], states[3], states[4], states[5], states[
              6], states[7], states[8], states[9], states[10], states[11], states[12], states[13], states[14], states[15], states[16], states[17], states[18], states[19], states[20], states[21], states[22], states[23]))
        print(dash)
    print("{:<7}{:<7}{:<7}{:<7}{:<7}{:<7}{:<7}{:<7}{:<7}{:<7}{:<7}{:<7}{:<7}{:<7}{:<7}{:<7}{:<7}{:<7}{:<7}{:<7}{:<7}{:<7}{:<7}{:<7}{:<2s}{:<4s}{:<2s}".format(tProb[i][0], tProb[i][1], tProb[i][2], tProb[i][3], tProb[i][4], tProb[i][5], tProb[i][6], tProb[i][
          7], tProb[i][8], tProb[i][9], tProb[i][10], tProb[i][11], tProb[i][12], tProb[i][13], tProb[i][14], tProb[i][15], tProb[i][16], tProb[i][17], tProb[i][18], tProb[i][19], tProb[i][20], tProb[i][21], tProb[i][22], tProb[i][23], line, states[i], line))
print(dash)
...
print(endMatrix)
print(dash)
print("Chord Progression: " + str(multPower) + " iterations")
